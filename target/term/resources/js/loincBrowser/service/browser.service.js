...
(function () {
	...
	angular
		...
		.service('lncbrowserservice', BrowserService);
	
	BrowserService.$inject = ['$window', '$log', 'dataservice'];
	function BrowserService($window, $log) {

		var service = this;
	
		// search history key for localstorage
		var srchHistKey = 'lncSrchHistory';
		...
		function setLanguage(lang) {
			langCtry = lang;
			$log.debug('<Method call> Loinc SetLanguage: ' + lang);
		};
